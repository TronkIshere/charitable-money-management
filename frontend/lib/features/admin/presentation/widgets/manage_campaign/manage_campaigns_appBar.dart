...
class ManageCampaignsAppbar extends StatelessWidget implements PreferredSizeWidget {
  final String title;
  final VoidCallback? onBack;

  const ManageCampaignsAppbar({super.key, required this.title, this.onBack});
