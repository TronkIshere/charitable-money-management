...
class CampaignsSearchingFilterBar extends StatefulWidget {
  const CampaignsSearchingFilterBar({super.key});

  @override
  State<CampaignsSearchingFilterBar> createState() => _CampaignsSearchingFilterBarState();
}

class _CampaignsSearchingFilterBarState extends State<CampaignsSearchingFilterBar> {
      ...
      child: Row(
        ...
        children: [
          const Text(
            ...
            style: TextStyle(color: DefaultColors.greyText, fontWeight: FontWeight.w600, fontSize: 16),
